...
public class MenuButton extends AbstractMenu implements org.primefaces.component.api.Widget {
	...
	public java.lang.String getButtonStyleClass() {
		return (java.lang.String) getStateHelper().eval(PropertyKeys.buttonStyleClass, null);
	}
	public void setButtonStyleClass(java.lang.String _styleClass) {
		getStateHelper().put(PropertyKeys.buttonStyleClass, _styleClass);
	}
	public java.lang.String getIconStyleClass() {
		return (java.lang.String) getStateHelper().eval(PropertyKeys.iconStyleClass, null);
	}
	public void setIconStyleClass(java.lang.String _styleClass) {
		getStateHelper().put(PropertyKeys.iconStyleClass, _styleClass);
	}
