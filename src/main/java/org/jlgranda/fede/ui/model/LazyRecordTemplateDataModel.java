 ...
 * @author jlgranda
 */
public class LazyRecordTemplateDataModel  extends LazyDataModel<RecordTemplate> implements Serializable {
    private static final int MAX_RESULTS = 5;
    private static final long serialVersionUID = -3989987588787365293L;

    Logger logger = LoggerFactory.getLogger(LazyRecordTemplateDataModel.class);

    private RecordTemplateService bussinesEntityService;

    private List<RecordTemplate> resultList;
    ...
    public LazyRecordTemplateDataModel(RecordTemplateService bussinesEntityService) {
    ...
    public List<RecordTemplate> getResultList() {
    ...
    @Override
    public RecordTemplate getRowData(String rowKey) {
        return bussinesEntityService.find(Long.valueOf(rowKey));
    }

    @Override
    public String getRowKey(RecordTemplate entity) {
        return "" + entity.getId();
    }

    @Override
    public List<RecordTemplate> load(int first, int pageSize, Map<String, SortMeta> sortBy, Map<String, FilterMeta> filters) {
        ...
        if (sortField == null) {
            sortField = RecordTemplate_.createdOn.getName();
        }

        QueryData<RecordTemplate> qData = bussinesEntityService.find(first, _end, sortField, order, _filters);
