...
public class LazyTemplateDataModel extends LazyDataModel<Template> implements Serializable {
    ...
    @Override
    public Object getRowKey(Template entity) {
        return entity.getName();
    }

    @Override
    public List<Template> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        ...
        QueryData<Template> qData = service.find(first, end, sortField, order, _filters);
