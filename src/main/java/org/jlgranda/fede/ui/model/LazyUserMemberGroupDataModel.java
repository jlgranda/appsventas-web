 ...
 * @author Jorge
 */
public class LazyUserMemberGroupDataModel extends LazyDataModel<Group> implements Serializable {
    ...
    public LazyUserMemberGroupDataModel(SecurityGroupService securityGroupService, User user) {
    ...
    public List<Group> getResultList() {
        ...
        if (resultList.isEmpty()/* && getSelectedBussinesEntity() != null*/) {
            ...
            resultList = securityGroupService.find(this.getPageSize(), this.getFirstResult(), user);
        }
        return resultList;
    }
    ...
    public List<Group> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        ...
        result = securityGroupService.find(first, end, sortField, order, _filters, user);
